...
fun main() {
    fun run(
        i1: Int, i2: Int, i3: Int, i4: Int, i5: Int, i6: Int, i7: Int,
        ...
        z += (i11 + 6) * b5
        x =
            z // ((((((((i1 * 17576 + i2 * 676 + i3 * 26 + i4 + 97750)/26)/26)/26) * 26 + i8 + 13) * 26 + i9 + 16)/26)/26)
        val b6 = if (x % 26 - 11 == i12) 0 else 1
        z = z / 26 * 25 * b6 + z / 26
        z += (i12 + 9) * b6
        z = z * 26 + i13 + 11
        x =
            z // ((((((((((i1 * 17576 + i2 * 676 + i3 * 26 + i4 + 97750)/26)/26)/26) * 26 + i8 + 13) * 26 + i9 + 16)/26)/26)) * 26 + i13 + 11)
    ...
    for (i1 in 1..9)
        for (i2 in 1..9)
            for (i3 in 1..9)
                for (i4 in 1..9)
                    for (i5 in 1..9) {
                        val p1 = i1 * 17576 + i2 * 676 + i3 * 26 + i4 + 97750
                        if (i5 == p1 % 26 - 16)
                            for (i6 in 1..9) {
                                val p2 = p1 / 26
                                if (i6 == p2 % 26 - 11)
                                    for (i7 in 1..9) {
                                        ...
                                        if (p3 % 26 - 6 == i7)
                                            for (i8 in 1..9)
                                                for (i9 in 1..9)
                                                    for (i10 in 1..9) {
                                                        val p4 = ((p3 / 26) * 26 + i8 + 13) * 26 + i9 + 16
                                                        if (p4 % 26 - 10 == i10)
                                                            for (i11 in 1..9)
                                                                if ((p4 / 26) % 26 - 8 == i11)
                                                                    for (i12 in 1..9)
                                                                        if (((p4 / 26) / 26) % 26 - 11 == i12)
                                                                            for (i13 in 1..9)
                                                                                for (i14 in 1..9)
                                                                                    if (((((p4 / 26) / 26)) * 26 + i13 + 11) % 26 - 15 == i14)
